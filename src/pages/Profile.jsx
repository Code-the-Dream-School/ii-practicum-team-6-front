      ...
      <div className="bg-white  rounded-xl shadow-md max-w-4xl w-full p-8 transition-all duration-300 animate-fade-in border border-gray-200 relative -mt-55">
        <div className="flex flex-col md:flex-row w-full">
          ...
          <div className="md:w-1/3 text-center mb-8 md:mb-0">
            {/* Generic Avatar Icon */}
            <div className="mx-auto mb-4 flex items-center justify-center w-40 h-40 rounded-full bg-gray-100  border-4 dark:border-gray-600">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="h-32 w-32 text-gray-800 dark:text-gray-500"
                fill="none"
                viewBox="0 0 24 24"
                stroke="currentColor"
              >
